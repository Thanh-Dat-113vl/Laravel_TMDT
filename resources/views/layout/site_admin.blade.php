    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="">
                ...
                <div class="sidebar-brand-text mx-3">Material Shop</div>
            </a>
            ...
            <li class="nav-item active">
                <a class="nav-link" href="{{ route('Caterogy') }}">
            ...
            <li class="nav-item active">
                <a class="nav-link" href="{{ route('getRatings') }}">
                    <i class="fas fa-fw fa-tachometer-alt"></i>
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Theo Danh Mục:</h6>
                        <a class="collapse-item" href="{{ route('adminProduct') }}">Tất cả</a>
